...
WHITELIST = [
    ...
    # whitelisted until cl/233644240 is addressed, perhaps by cl/233678294.
    'go_gapic@google/pubsub/artman_pubsub.yaml',
    'csharp_gapic@google/pubsub/artman_pubsub.yaml',
]
